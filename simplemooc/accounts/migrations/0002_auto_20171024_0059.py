# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-24 00:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirm', models.BooleanField(default=False, verbose_name='Senha Resetada?')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='password_reset', to=settings.AUTH_USER_MODEL, verbose_name='Usuário'),
        ),
    ]
