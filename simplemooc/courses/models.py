...
class Course(models.Model):
    ...
    class Meta:
        ...
        ordering = ['name'] #ordenação da classe pelo campo nome
...
class Enrollment(models.Model):
    ...
    status = models.IntegerField(verbose_name='Situação', choices=STATUS_CHOICES,
...
class Comment(models.Model):
    ...
    announcement = models.ForeignKey(Announcements, verbose_name='Anúncio',
